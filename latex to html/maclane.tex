...
\end{exercise}
\begin{solution}[Reid Barton, \href{http://mathoverflow.net/questions/4276/two-functors-from-grp-to-grp}{mathoverflow}]
...
\[\psi(m)(A)=\sigma\psi(m)\sigma(A)=\begin{cases}
...
\varnothing&\text{, if }A=\varnothing\\
nA&\text{, if }A\neq\varnothing.
\end{cases},\quad\text{whereas}\quad\sigma\psi(n)\sigma(A)=\begin{cases}
...
\begin{denv*}{Remark to Exercise 8}
...
For $t\in [0,1]$,
\begin{align*}
(\tau'\cdot\sigma')\circ(\tau\cdot\sigma)(t)&=\begin{cases}(\tau\cdot\sigma)(2t)&,0\leq t\leq 1/2\\(\tau'\cdot\sigma')(2t-1)&,1/2\leq t\leq 1\end{cases}\\
&=\begin{cases}\tau(2t)\sigma(2t)&,1/2\leq t\leq 1\\\tau(2t-1)\sigma(2t-1)&,1/2\leq t\leq 1\end{cases}\\
...
\end{exercise}
\begin{solution}[Hurkyl, \href{http://math.stackexchange.com/questions/818624/center-of-the-categories-mathbfgrp-and-mathbfab}{math.stackexchange.com}]
...
\begin{tikzcd}E\arrow[d,"T"]\\C\\D\arrow[u,"S",swap]\end{tikzcd};
\qquad\text{arrows }\langle{\tau_u,\tau_c,\tau_d}\rangle:\quad
\begin{tikzcd}E\arrow[d,"T",swap] \arrow[r,"\tau_u"] &E'\arrow[d,"T'"]\\C\arrow[r,"\tau_c"]&C'\\D\arrow[u,"S"]\arrow[r,"\tau_d"]&D'\arrow[u,"S'",swap]\end{tikzcd}\]
...
\vspace{-5pt}\[\begin{tikzcd}[column sep=huge,row sep=huge]
