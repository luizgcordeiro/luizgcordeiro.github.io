...
\geometry{left=.8in, right=.8in, top=1in, bottom=1in}
...
%This work was supported by CAPES/Ciência Sem Fronteiras PhD scholarship 012035/2013-00, under supervision of Thierry Giordano and Vladimir Pestov.
...
\begin{enumerate}
\item[(i)] $\lim_{k\to\infty}\operatorname{tr}(\pi_k(\alpha))=\operatorname{tr}(\alpha)$;
\item[(ii)] $\lim_{k\to\infty}d_\#(\pi_k(\alpha\beta),\pi_k(\alpha)\pi_k(\beta))=0$.
\end{enumerate}
...
\begin{enumerate}
\item[(i)] if $s(\alpha_i)\cap s(\alpha_j)$ and $s(\beta_i)\cap s(\beta_j)$ are both nonempty then $i=j$;
\item[(ii)] if $r(\alpha_i)\cap r(\alpha_j)$ and $r(\beta_i)\cap r(\beta_j)$ are both nonempty then $i=j$.
\end{enumerate}
...
\begin{enumerate}
\item[(i)] $\lim_{k\to\infty}d(\pi_k(\alpha),\pi_k(\beta))=d(\alpha,\beta)$;
\item[(ii)] $\lim_{k\to\infty}d_\#(\pi_k(\alpha\beta),\pi_k(\alpha)\pi_k(\beta))=0$.
\end{enumerate}
\end{definition}
