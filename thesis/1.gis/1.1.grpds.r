...
<div class="reference" id="refdefinitionsmallcategoryassociativity">
<li> If $(a,b)$ and $(b,c)\in\mathcal{C}^{(2)}$, then $(a,bc),(ab,c)\in\mathcal{C}^{(2)}$ and $a(bc)=(ab)c$.</li>
</div>
<div class="reference" id="refdefinitionsmallcategoryidentities">
<li> For every $x\in\mathcal{C}^{(0)}$, there exists $\operatorname{id}_x\in \mathcal{C}_x^x$ such that if $a\in\mathcal{C}_x$ and $b\in\mathcal{C}^ x$, then $a\operatorname{id}_x=a$ and $\operatorname{id}_xb=b$.</li>
</div>
...
<div class="example reference" id="refexamplemonoidsarecategories">
	...
	<a href="#definitioninversesemigroup">click me</a>
...
<div class="example reference" id="refmonoidactioncategory">
	...
	<p>
	Note that if $X$ is a singleton $X=\left\{*\right\}$ and $M$ acts on $X$ trivially, we recover Example <a class="makeref" data-target="refexamplemonoidsarecategories" href="#examplemonoidsarecategories">1.1.9</a>.
	</p>
</div>
...
<div class="reference" id="refalgebraicdefinitiongroupoid1">
	<li>If $(a,b)$ and $(b,c)\in\mathcal{G}^{(2)}$, then $(ab,c)$ and $(a,bc)\in\mathcal{G}^{(2)}$ and $(ab)c=a(bc)$;</li>
</div>

<div class="reference" id="refalgebraicdefinitiongroupoid2">
<li>For all $a\in\mathcal{G}$, there is $p\in\mathcal{G}$ such that $(p,a)\in\mathcal{G}^{(2)}$ and if $(a,b)\in\mathcal{G}^{(2)}$, then $(pa)b=b$;</li>
</div>

<div class="reference" id="refalgebraicdefinitiongroupoid3">
...
<p>
Alternatively, let $X^{(2)}$ be the identity equivalence relation on $X$, regarded as a groupoid as in Example <a class="makeref" data-target="refexampleequivalencerelationsarecategories" href="#exampleequivalencerelationsarecategories">1.1.14</a>, or let $\left\{1\right\}$ be the trivial group acting (trivially) on $X$ and consider the transformation groupoid $\left\{1\right\}\ltimes X$ as in <a class="makeref" data-target="refexampletransformationgroupoid" href="#exampletransformationgroupoid">1.1.13</a>. Any of the two bijections
\[\begin{array}{rcl}
